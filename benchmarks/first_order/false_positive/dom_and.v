...
//   xor g7 (n_11, Xi_mul_Yj, ZxDI);
  not g65 (n_a1, Xi_mul_Yj);
  not g66 (n_b1, ZxDI);
  and g67 (n_t11, Xi_mul_Yj, n_b1);
  and g68 (n_t21, ZxDI, n_a1);
  or g69 (n_11, n_t11, n_t21);

  xor g9 (n_13, Xi_mul_Yj_37, ZxDI);
//  not g60 (n_a, Xi_mul_Yj_37);
//  not g61 (n_b, ZxDI);
//  and g62 (n_t1, Xi_mul_Yj_37, n_b);
//  and g63 (n_t2, ZxDI, n_a);
//  or g64 (n_13, n_t1, n_t2);

  xor g11 (QxDO[1], FFxDP[2], \Xi_mul_Yj[3] );
//  not g70 (n_a2, FFxDP[2]);
//  not g71 (n_b2, \Xi_mul_Yj[3] );
//  and g72 (n_t12, FFxDP[2], n_b2);
//  and g73 (n_t22, n_a2, \Xi_mul_Yj[3] );
//  or g74 (QxDO[1], n_t12, n_t22);

  xor g8 (QxDO[0], \Xi_mul_Yj[0] , FFxDP[1]);
//  not g75 (n_a3, FFxDP[1]);
//  not g76 (n_b3, \Xi_mul_Yj[0] );
//  and g77 (n_t13, FFxDP[1], n_b3);
//  and g78 (n_t23, n_a3, \Xi_mul_Yj[0] );
//  or g79 (QxDO[0], n_t13, n_t23);
